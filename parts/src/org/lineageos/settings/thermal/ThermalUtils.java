...
public final class ThermalUtils {
    ...
    protected static final int STATE_PUBG = 5;
    ...
    private static final String THERMAL_STATE_EXTREME = "2";
    private static final String THERMAL_STATE_GAMING = "13";
    private static final String THERMAL_STATE_PUBG = "16";
    ...
    private static final String THERMAL_EXTREME = "thermal.extreme=";
    private static final String THERMAL_GAMING = "thermal.gaming=";
    private static final String THERMAL_PUBG = "thermal.pubg";
    ...
    private String getValue() {
        ...
        if (value == null || value.isEmpty()) {
            value = THERMAL_BENCHMARK + ":" + THERMAL_CAMERA + ":" + THERMAL_EXTREME + ":" +
                    THERMAL_GAMING + ":" + THERMAL_PUBG + ":" +  THERMAL_STREAMING;
            writeValue(value);
        }
        return value;
    }
    ...
    protected void setThermalProfile(String packageName) {
        ...
        if (value != null) {
            ...
            if (modes[0].contains(packageName + ",")) {
                ...
                state = THERMAL_STATE_EXTREME;
            } else if (modes[3].contains(packageName + ",")) {
                state = THERMAL_STATE_GAMING;
            } else if (modes[4].contains(packageName + ",")) {
                state = THERMAL_STATE_PUBG;
            } else if (modes[5].contains(packageName + ",")) {
